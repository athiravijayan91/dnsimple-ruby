...
class TransfersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transfer" do
    assert_difference('Transfer.count') do
      post transfers_url, params: { transfer: { domain_id: @transfer.domain_id, domain_name: @transfer.domain_name } }
    end
  ...
  test "should update transfer" do
    patch transfer_url(@transfer), params: { transfer: { domain_id: @transfer.domain_id, domain_name: @transfer.domain_name } }
