...
class TemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create template" do
    assert_difference('Template.count') do
      post templates_url, params: { template: { domain_id: @template.domain_id, domain_name: @template.domain_name } }
    end
  ...
  test "should update template" do
    patch template_url(@template), params: { template: { domain_id: @template.domain_id, domain_name: @template.domain_name } }
