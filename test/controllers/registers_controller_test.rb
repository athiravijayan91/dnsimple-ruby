...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post registers_url, params: { register: { domain_id: @register.domain_id, domain_name: @register.domain_name } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { domain_id: @register.domain_id, domain_name: @register.domain_name } }
